...
interface ProductCategoryChoicePanelProps extends RouteComponentProps {
    productId: string,
    redirectUrl: string,
}
type ProductCategoryChoicePanelState = {
    treeData: [],
...
class ProductCategoryChoicePanelProps extends React.Component<ProductCategoryChoicePanelProps, ProductCategoryChoicePanelState> {
    constructor(props: ProductCategoryChoicePanelProps) {
        super(props);
